 ...
 * @LastEditTime: 2020-07-03 14:57:46
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /cssToInterface/index.js
 */ 
const fs = require('fs')
...
module.exports = function(content, ...rest) {
    ...
    const localExports = content.split('exports.locals')[1] || content

    console.log(localExports)
    while ((match = keyRegex.exec(localExports))) {
        if (cssModuleKeys.indexOf(match[1]) < 0) {
            cssModuleKeys.push(match[0].slice(1))
        }
    }
